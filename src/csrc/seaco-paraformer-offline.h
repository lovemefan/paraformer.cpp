...
#ifndef PARAFORMER_CPP_SEACO_PARAFORMER_OFFLINE_H
#define PARAFORMER_CPP_SEACO_PARAFORMER_OFFLINE_H
...
#endif  // PARAFORMER_CPP_SEACO_PARAFORMER_OFFLINE_H
